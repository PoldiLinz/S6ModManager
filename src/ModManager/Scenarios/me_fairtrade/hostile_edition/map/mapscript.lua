...
function Mission_InitPlayers()
    ...
    AddResourcesToPlayer(Goods.G_Wood, 50, GreenleavesPlayerID)
    AddResourcesToPlayer(Goods.G_Stone, 30, GreenleavesPlayerID)
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
-- 30-MINUTEN SCHONFRIST-TIMER (1800 Sekunden)
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AttackCountdown()

    if AttackWaitCounter == nil then
        AttackWaitCounter = 1800 -- 30 Minuten Schonfrist in Sekunden
    end
